# A :surfing*man:[\_Keys*](github.com/brookhong/Surfingkeys) Conf.

This is my **config** for the browser extension [_SurfingKeys_](https://github.com/brookhong/Surfingkeys)!

Including:

- [260+ mapping for 100+ unique websites](#site-specific-key-mappings).
- [Omnibar integration, Search Engines and Knowledge Sources](#omnibar-search-engine-integrations).

## MOC.

1. [Site-Specific Key Mappings](#key-mappings)
